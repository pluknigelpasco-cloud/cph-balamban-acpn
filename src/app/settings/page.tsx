...
import { Settings, Save, CheckCircle2, ShieldCheck, FileText, UserCheck, Hospital, RotateCcw } from 'lucide-react';
...
const defaultSignatories: HospitalSignatories = {
  ...
  facilityAddress: 'Aliwan, Balamban, Cebu',
  hciNo: 'H07020344'
};
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-500">Document Signatories & Hospital Details</span>
          </div>
          <h1 className="text-2xl font-bold text-slate-900 mt-1">Signatories & Hospital Settings</h1>
          <p className="text-sm text-slate-500">
            Customize the official names, titles, and designations printed on all Doctor Payslips, Vouchers, and Reports.
          </p>
        </div>
